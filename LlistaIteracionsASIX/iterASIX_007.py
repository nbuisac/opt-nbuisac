# 7. Analitzador de Logs d'Apache: En una llista de frases donada que simulen un log
# (amb IPs i codis d'error com 200, 404, 500).
# Recorre les línies i compta quants errors "404" hi ha.
LINIES_A_ANALITZAR = [
...
for l in LINIES_A_ANALITZAR:
    if l.split(" ")[8] == CODI_A_TROBAR:
        comptador = comptador + 1
        print(l)
print(f"Hem trobatt {comptador} linies amb codi {CODI_A_TROBAR}")